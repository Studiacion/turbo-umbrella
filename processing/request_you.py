...
directory_path = script_path.replace("/processing/request_you.py", "")
...
req = youtube.search().list(q = 'coronavirus candada', part = 'snippet', type = 'video', eventType = 'completed', maxResults = 1, regionCode = 'CA')
res_CA = req.execute()
...
f = open("{}/data/video_ID.txt".format(directory_path), "w")
