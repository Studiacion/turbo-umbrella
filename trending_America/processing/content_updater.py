...
f = open("/home/javier/html_v/simplestyle_bluetrees/page.html", "w")
...
f.write('<head>')
f.write('  <title>simplestyle_blue_trees - a page</title>')
...
f.write('          <li class=\"selected\"><a href=\"page.html\">A Page</a></li>')
